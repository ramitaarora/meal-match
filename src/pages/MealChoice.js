      ...
      <div>
        ...
        <div className="flipping-buttons">
          <div className="next" onClick={nextMeal}>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-emoji-neutral-fill" viewBox="0 0 16 16">
          ...
          <div className="heart" onClick={selectMeal}>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-emoji-heart-eyes-fill" viewBox="0 0 16 16">
