...
import {mealOptionsData, allOptionsData, mealChoice, back} from '../App.js';
    ...
    <div className="meal-choice">
      ...
      <div className="flipping-buttons">
        <div className="next" onClick={nextMeal}>
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="grey" class="bi bi-emoji-neutral-fill" viewBox="0 0 16 16">
