export default function Nav({back, search, slide, setSlide}) {
    ...
    return (
        <div id="navigation">
            ...
            <svg id="home-svg" onClick={handleHome} xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" fill="black" className="bi bi-house-door-fill" viewBox="0 0 16 16">
		...
		c7.703-7.588,7.703-20.02,0-27.664C344.529,327.504,344.424,327.458,344.308,327.389z"/>
            ...
            <svg id="search-svg" onClick={handleSearch} xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" fill="black" className="bi bi-search" viewBox="0 0 16 16">
